...
[MURDOKU BOOK SCAN](../reference/murdoku-book.cave.md) CONFIRM OUR SEAT/DECORATIVE SPLIT
MATCH SOURCE MATERIAL EXACT ("KAN BEZET WORDEN" VS "KUNNEN NIET BEZET WORDEN"). ALSO
FLAG TWO ASSET IDEA NOT YET BUILD: **DOOR** (BLOCK DECORATIVE PROP, SEE CASE 76) + **WINDOW
EDGE-ONLY RULE** (RAAM ONLY SIT OUTER BOARD EDGE, SEE CASE 4) — NEITHER NEED NEW
PREDICATE, JUST NEW ASSET + (FOR WINDOW) NEW PLACEMENT CONSTRAINT IF EVER ADOPT.

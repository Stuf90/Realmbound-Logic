...
PHYSICAL MURDOKU BOOK SCAN (PHOTO + NOTE) LIVE
[`reference/murdoku-book.cave.md`](../reference/murdoku-book.cave.md) — WORKED EXAMPLE
FOR EVERY PREDICATE ABOVE, PLUS BACKLOG LIST OF CLUE SHAPE ADVANCED CASE USE THAT NO
CURRENT PREDICATE MODEL (DIAGONAL, RELATIVE OFFSET, OCCUPANCY COUNT, ATTRIBUTE/CATEGORY,
SHARED-PROP PAIRING, DISJUNCTIVE CORNER SET, GLOBAL UNIQUENESS QUANTIFIER, NOT-BESIDE-
WALL). CHECK THAT DOC BEFORE PROPOSE NEW PREDICATE VARIANT — MAYBE ALREADY SCOUT.

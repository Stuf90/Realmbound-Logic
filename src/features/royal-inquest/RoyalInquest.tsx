      ...
      <section className="board-panel" aria-label="Castle floor plan">
        ...
        >
          {definition.cells.map((cell) => {
            ...
            const draftLabel = !isCrossed && draftCharacters.length

...
export function App() {
  ...
  if (family.id === 'royal-inquest') return <RoyalInquest level={royalInquestLevels[view.levelIndex - 1]!} onBack={showLevels} />;
  return null;
}
...
function PuzzleLedger({ onSelect }: { onSelect: (familyId: PuzzleFamilyId) => void }) {
  return <main className="app-shell">
    ...
    <section className="commission-list" role="region" aria-label="Puzzle families">
